...
public class ProductController {
    ...
    public List<Product> getAllProducts(@PathVariable BigInteger id,@PathVariable BigInteger userId) {
    ...
    public Product getProduct(@PathVariable BigInteger id,@PathVariable BigInteger userId,@PathVariable BigInteger orderId){
    ...
    @RequestMapping(method = RequestMethod.DELETE, value="users/{usersId}/orders/{orderId}/products/{id}")
